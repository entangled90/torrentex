defmodule TorrentexLib.Torrent.Torrent do
  @moduledoc """
  Start downloading a torrent given a path to a torrent file or a magnet link

  {:ok, pid} = TorrentexLib.Torrent.Torrent.start_link("../../data/ubuntu-20.04.2.0-desktop-amd64.iso.torrent")
  {:ok, pid} = TorrentexLib.Torrent.Torrent.start_link("../../data/Fedora-KDE-Live-x86_64-33.torrent")

  """
  alias TorrentexLib.Torrent.{
    FilesWriter,
    Parser,
    Peer,
